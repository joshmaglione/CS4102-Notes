...
\begin{description}
    ...
    \begin{description}
      ...
      \item[Website:] \href{https://universityofgalway.instructure.com/}{\textsf{Canvas}} and \url{https://joshmaglione.com/2026CS4102.html} 
    \end{description} 
    \vspace{1cm}
    ...
    components: 
    \begin{itemize}
      \item five in-class quizzes (10\%),
      \item an in-class exam (30\%),
      \item and a final exam (60\%).
    \end{itemize} 
    We will have a quiz every other week, for a total of six
    quizzes. The lowest score will not be counted. The in-class exam is
    tentatively scheduled for the 21st of October (Wednesday in week 7);
